      ...
      <ThemeProvider>
        ...
        <Grid>
          <GridItem size={[4]}>
            ...
            <h1>Heading Text</h1>
            <p>
              Vivamus magna justo, lacinia eget consectetur sed, convallis at tellus. Donec rutrum congue leo eget
              malesuada. Curabitur non nulla sit amet nisl tempus convallis quis ac lectus.
            </p>
            <Button variant="primary" disabled={swiper ? swiper.isBeginning : false} onClick={() => slidePrev()}>
              Prev Slide
            </Button>
            <Button variant="primary" disabled={swiper ? swiper.isEnd : false} onClick={() => slideNext()}>
              Next Slide
            </Button>
          </GridItem>
          <GridItem size={8}>
