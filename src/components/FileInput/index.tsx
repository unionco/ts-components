  ...
  return (
    <StyledInputWrapper color={color}>
      <StyledFileInput
        ...
        type={type}
        {...props}
        onChange={(e: React.ChangeEvent<HTMLInputElement>) => proxyChange(e)}
      />
      {label && (
        <>
...
export const FileInput = forwardRef<Ref, FileInputProps>((props, ref) => <FileInputComponent ref={ref} {...props} />);
