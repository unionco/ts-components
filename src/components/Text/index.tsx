  ...
  ${props => variant({
    variants: {
      display: {
        ...
        fontSize: props.theme.fontSizes.xxlg,
        lineHeight: props.theme.lineHeights.xxlg,
      },
      h1: {
        fontFamily: props.theme.fonts.h1,
        fontSize: props.theme.fontSizes.xlg,
        lineHeight: props.theme.lineHeights.xlg,
      },
    }
  })}
`;
